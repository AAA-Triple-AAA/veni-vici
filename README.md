# Web Development Project 4 - *TRIPLE A's FILM CURATOR*

Submitted by: **Adrian Abella Acosta**

This web app: **Supplies user with random film and user can choose to remove certain attributes to never see in future generated suggestions.**
